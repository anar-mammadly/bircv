...
export const TEMPLATE_LIST: TemplateMeta[] = [
  ...
  { id: 'modern', name: 'Modern', premium: false, color: '#2563EB', categories: ['modern', 'professional', 'ats'], origin: 'improved',
  ...
  { id: 'designer', name: 'Designer', premium: false, color: '#3A1F3D', categories: ['creative', 'modern'], origin: 'improved',
