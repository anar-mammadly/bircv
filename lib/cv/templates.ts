...
export const TEMPLATE_LIST: TemplateMeta[] = [
  { id: 'kompakt', name: 'Kompakt', premium: false, color: '#4338CA', categories: ['professional', 'modern'], origin: 'improved',
    description: { az: 'Solda əlaqə və bacarıqlar, sağda təcrübə. Sıx və oxunaqlı.', en: 'Contact and skills on the left, experience on the right. Dense yet readable.' } },
  { id: 'modern', name: 'Modern', premium: false, color: '#1E40AF', categories: ['modern', 'professional'], origin: 'improved',
    description: { az: 'Rəngli başlıq, təmiz bölmələr və zərif tarix sütunu.', en: 'Colour header, clean sections and a refined date column.' } },
  ...
  { id: 'designer', name: 'Designer', premium: false, color: '#6366F1', categories: ['creative', 'modern'], origin: 'preserved',
    description: { az: 'Kart düzümü, şirkət loqoları və dil səviyyə zolaqları.', en: 'Card layout with company badges and language level bars.' } },
  { id: 'header', name: 'Header', premium: false, color: '#0F2A5E', categories: ['professional', 'executive'], origin: 'preserved',
    description: { az: 'Tünd başlıq və iki sütunlu zaman xətti.', en: 'Deep navy header with a two-column timeline.' } },
